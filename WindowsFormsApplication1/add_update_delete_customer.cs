...
{
    public partial class add_update_delete_customer : Form
    {
        public add_update_delete_customer()
        {
            InitializeComponent();
            Member.read_members();
        ...
        private void addCustomer_Click(object sender, EventArgs e)
        {
           ...
           // Program.transactionList.Add(AC);
            ...
            foreach (Member i in Program.memberList)
            {
                if (i._id == id)
                {
                   // AccountTransaction individualTransaction = new AccountTransaction(0, 0, 20, "M", customer);
                    //Program.individualTransactionList.Add(individualTransaction);
        ...
        private void return_btn_Click(object sender, EventArgs e)
        {
            ...
            this.Close();
            Form staffMember = new staffMember();
            staffMember.Show();
        }
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            foreach (ListViewItem member in listView1.SelectedItems)
            {
                ...
                textBoxCustomerPNr.Text = member.SubItems[3].Text;
                textBoxCustomerAddress.Text = member.SubItems[4].Text;
            }
        }
